...
$cfgrubros_edit = NULL; // Initialize page object first

class ccfgrubros_edit extends ccfgrubros {
	...
	// Page object name
	var $PageObjName = 'cfgrubros_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// condiciones
			$this->condiciones->SetDbValueDef($rsnew, $this->condiciones->CurrentValue, NULL, $this->condiciones->ReadOnly);
...
// Create page object
if (!isset($cfgrubros_edit)) $cfgrubros_edit = new ccfgrubros_edit();

// Page init
$cfgrubros_edit->Page_Init();

// Page main
$cfgrubros_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfgrubros_edit->Page_Render();
?>
...
var CurrentForm = fcfgrubrosedit = new ew_Form("fcfgrubrosedit", "edit");

// Validate form
fcfgrubrosedit.Validate = function() {
...
fcfgrubrosedit.Form_CustomValidate = 
...
fcfgrubrosedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcfgrubrosedit.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfgrubrosedit.Lists["x_activo"].Options = <?php echo json_encode($cfgrubros_edit->activo->Options()) ?>;
...
<?php $cfgrubros_edit->ShowPageHeader(); ?>
<?php
$cfgrubros_edit->ShowMessage();
?>
<form name="fcfgrubrosedit" id="fcfgrubrosedit" class="<?php echo $cfgrubros_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfgrubros_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfgrubros_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cfgrubros">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cfgrubros_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($cfgrubros->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_cfgrubros_id" class="<?php echo $cfgrubros_edit->LeftColumnClass ?>"><?php echo $cfgrubros->id->FldCaption() ?></label>
		<div class="<?php echo $cfgrubros_edit->RightColumnClass ?>"><div<?php echo $cfgrubros->id->CellAttributes() ?>>
<span id="el_cfgrubros_id">
<span<?php echo $cfgrubros->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $cfgrubros->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="cfgrubros" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($cfgrubros->id->CurrentValue) ?>">
<?php echo $cfgrubros->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cfgrubros->rubro->Visible) { // rubro ?>
	<div id="r_rubro" class="form-group">
		<label id="elh_cfgrubros_rubro" for="x_rubro" class="<?php echo $cfgrubros_edit->LeftColumnClass ?>"><?php echo $cfgrubros->rubro->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgrubros_edit->RightColumnClass ?>"><div<?php echo $cfgrubros->rubro->CellAttributes() ?>>
...
<?php if ($cfgrubros->condiciones->Visible) { // condiciones ?>
	<div id="r_condiciones" class="form-group">
		<label id="elh_cfgrubros_condiciones" for="x_condiciones" class="<?php echo $cfgrubros_edit->LeftColumnClass ?>"><?php echo $cfgrubros->condiciones->FldCaption() ?></label>
		<div class="<?php echo $cfgrubros_edit->RightColumnClass ?>"><div<?php echo $cfgrubros->condiciones->CellAttributes() ?>>
...
<?php if ($cfgrubros->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group">
		<label id="elh_cfgrubros_keywords" for="x_keywords" class="<?php echo $cfgrubros_edit->LeftColumnClass ?>"><?php echo $cfgrubros->keywords->FldCaption() ?></label>
		<div class="<?php echo $cfgrubros_edit->RightColumnClass ?>"><div<?php echo $cfgrubros->keywords->CellAttributes() ?>>
...
<?php if ($cfgrubros->foto->Visible) { // foto ?>
	<div id="r_foto" class="form-group">
		<label id="elh_cfgrubros_foto" class="<?php echo $cfgrubros_edit->LeftColumnClass ?>"><?php echo $cfgrubros->foto->FldCaption() ?></label>
		<div class="<?php echo $cfgrubros_edit->RightColumnClass ?>"><div<?php echo $cfgrubros->foto->CellAttributes() ?>>
...
<?php if ($cfgrubros->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_cfgrubros_activo" for="x_activo" class="<?php echo $cfgrubros_edit->LeftColumnClass ?>"><?php echo $cfgrubros->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgrubros_edit->RightColumnClass ?>"><div<?php echo $cfgrubros->activo->CellAttributes() ?>>
...
<?php if (!$cfgrubros_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cfgrubros_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfgrubros_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
