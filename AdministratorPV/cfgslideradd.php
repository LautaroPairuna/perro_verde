...
$cfgslider_add = NULL; // Initialize page object first

class ccfgslider_add extends ccfgslider {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cfgsliderview.php")
	...
	function LoadDefaultValues() {
		...
		$this->thumbs->CurrentValue = NULL;
		$this->thumbs->OldValue = $this->thumbs->CurrentValue;
	...
	function NewRow() {
		...
		$row['thumbs'] = $this->thumbs->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// thumbs
		$this->thumbs->SetDbValueDef($rsnew, $this->thumbs->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($cfgslider_add)) $cfgslider_add = new ccfgslider_add();

// Page init
$cfgslider_add->Page_Init();

// Page main
$cfgslider_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfgslider_add->Page_Render();
?>
...
var CurrentForm = fcfgslideradd = new ew_Form("fcfgslideradd", "add");

// Validate form
fcfgslideradd.Validate = function() {
...
fcfgslideradd.Form_CustomValidate = 
...
fcfgslideradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcfgslideradd.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfgslideradd.Lists["x_activo"].Options = <?php echo json_encode($cfgslider_add->activo->Options()) ?>;
...
<?php $cfgslider_add->ShowPageHeader(); ?>
<?php
$cfgslider_add->ShowMessage();
?>
<form name="fcfgslideradd" id="fcfgslideradd" class="<?php echo $cfgslider_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfgslider_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfgslider_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cfgslider">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cfgslider_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($cfgslider->titulo->Visible) { // titulo ?>
	<div id="r_titulo" class="form-group">
		<label id="elh_cfgslider_titulo" for="x_titulo" class="<?php echo $cfgslider_add->LeftColumnClass ?>"><?php echo $cfgslider->titulo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgslider_add->RightColumnClass ?>"><div<?php echo $cfgslider->titulo->CellAttributes() ?>>
...
<?php if ($cfgslider->thumbs->Visible) { // thumbs ?>
	<div id="r_thumbs" class="form-group">
		<label id="elh_cfgslider_thumbs" for="x_thumbs" class="<?php echo $cfgslider_add->LeftColumnClass ?>"><?php echo $cfgslider->thumbs->FldCaption() ?></label>
		<div class="<?php echo $cfgslider_add->RightColumnClass ?>"><div<?php echo $cfgslider->thumbs->CellAttributes() ?>>
...
<?php if ($cfgslider->foto->Visible) { // foto ?>
	<div id="r_foto" class="form-group">
		<label id="elh_cfgslider_foto" class="<?php echo $cfgslider_add->LeftColumnClass ?>"><?php echo $cfgslider->foto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgslider_add->RightColumnClass ?>"><div<?php echo $cfgslider->foto->CellAttributes() ?>>
...
<?php if ($cfgslider->orden->Visible) { // orden ?>
	<div id="r_orden" class="form-group">
		<label id="elh_cfgslider_orden" for="x_orden" class="<?php echo $cfgslider_add->LeftColumnClass ?>"><?php echo $cfgslider->orden->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgslider_add->RightColumnClass ?>"><div<?php echo $cfgslider->orden->CellAttributes() ?>>
...
<?php if ($cfgslider->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_cfgslider_activo" for="x_activo" class="<?php echo $cfgslider_add->LeftColumnClass ?>"><?php echo $cfgslider->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgslider_add->RightColumnClass ?>"><div<?php echo $cfgslider->activo->CellAttributes() ?>>
...
<?php if (!$cfgslider_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cfgslider_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfgslider_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
