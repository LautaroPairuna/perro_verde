...
const PromotionsSlider: React.FC<PromotionsSliderProps> = React.memo(
  ({ images, interval = 5000 }) => {
    const [currentIndex, setCurrentIndex] = useState(0);
    const total = images.length;

    // Guardar el ID numérico de setInterval
