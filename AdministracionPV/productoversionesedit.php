...
$productoversiones_edit = NULL; // Initialize page object first

class cproductoversiones_edit extends cproductoversiones {
	...
	// Page object name
	var $PageObjName = 'productoversiones_edit';
...
// Create page object
if (!isset($productoversiones_edit)) $productoversiones_edit = new cproductoversiones_edit();

// Page init
$productoversiones_edit->Page_Init();

// Page main
$productoversiones_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$productoversiones_edit->Page_Render();
?>
...
var CurrentForm = fproductoversionesedit = new ew_Form("fproductoversionesedit", "edit");

// Validate form
fproductoversionesedit.Validate = function() {
...
fproductoversionesedit.Form_CustomValidate = 
...
fproductoversionesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductoversionesedit.Lists["x_producto_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_producto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"productos"};
fproductoversionesedit.Lists["x_producto_id"].Data = "<?php echo $productoversiones_edit->producto_id->LookupFilterQuery(FALSE, "edit") ?>";
fproductoversionesedit.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductoversionesedit.Lists["x_activo"].Options = <?php echo json_encode($productoversiones_edit->activo->Options()) ?>;
...
<?php $productoversiones_edit->ShowPageHeader(); ?>
<?php
$productoversiones_edit->ShowMessage();
?>
<form name="fproductoversionesedit" id="fproductoversionesedit" class="<?php echo $productoversiones_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($productoversiones_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $productoversiones_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="productoversiones">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($productoversiones_edit->IsModal) ?>">
...
<?php if ($productoversiones->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_productoversiones_id" class="<?php echo $productoversiones_edit->LeftColumnClass ?>"><?php echo $productoversiones->id->FldCaption() ?></label>
		<div class="<?php echo $productoversiones_edit->RightColumnClass ?>"><div<?php echo $productoversiones->id->CellAttributes() ?>>
<span id="el_productoversiones_id">
...
<input type="hidden" data-table="productoversiones" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($productoversiones->id->CurrentValue) ?>">
<?php echo $productoversiones->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($productoversiones->producto_id->Visible) { // producto_id ?>
	<div id="r_producto_id" class="form-group">
		<label id="elh_productoversiones_producto_id" for="x_producto_id" class="<?php echo $productoversiones_edit->LeftColumnClass ?>"><?php echo $productoversiones->producto_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoversiones_edit->RightColumnClass ?>"><div<?php echo $productoversiones->producto_id->CellAttributes() ?>>
...
<?php if ($productoversiones->version->Visible) { // version ?>
	<div id="r_version" class="form-group">
		<label id="elh_productoversiones_version" for="x_version" class="<?php echo $productoversiones_edit->LeftColumnClass ?>"><?php echo $productoversiones->version->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoversiones_edit->RightColumnClass ?>"><div<?php echo $productoversiones->version->CellAttributes() ?>>
...
<?php if ($productoversiones->detalle->Visible) { // detalle ?>
	<div id="r_detalle" class="form-group">
		<label id="elh_productoversiones_detalle" for="x_detalle" class="<?php echo $productoversiones_edit->LeftColumnClass ?>"><?php echo $productoversiones->detalle->FldCaption() ?></label>
		<div class="<?php echo $productoversiones_edit->RightColumnClass ?>"><div<?php echo $productoversiones->detalle->CellAttributes() ?>>
...
<?php if ($productoversiones->orden->Visible) { // orden ?>
	<div id="r_orden" class="form-group">
		<label id="elh_productoversiones_orden" for="x_orden" class="<?php echo $productoversiones_edit->LeftColumnClass ?>"><?php echo $productoversiones->orden->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoversiones_edit->RightColumnClass ?>"><div<?php echo $productoversiones->orden->CellAttributes() ?>>
...
<?php if ($productoversiones->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_productoversiones_activo" for="x_activo" class="<?php echo $productoversiones_edit->LeftColumnClass ?>"><?php echo $productoversiones->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoversiones_edit->RightColumnClass ?>"><div<?php echo $productoversiones->activo->CellAttributes() ?>>
...
<?php if (!$productoversiones_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $productoversiones_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $productoversiones_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fproductoversionesedit.Init();
</script>
<?php
$productoversiones_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$productoversiones_edit->Page_Terminate();
?>
