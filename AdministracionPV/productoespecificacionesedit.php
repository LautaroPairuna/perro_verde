...
$productoespecificaciones_edit = NULL; // Initialize page object first

class cproductoespecificaciones_edit extends cproductoespecificaciones {
	...
	// Page object name
	var $PageObjName = 'productoespecificaciones_edit';
...
// Create page object
if (!isset($productoespecificaciones_edit)) $productoespecificaciones_edit = new cproductoespecificaciones_edit();

// Page init
$productoespecificaciones_edit->Page_Init();

// Page main
$productoespecificaciones_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$productoespecificaciones_edit->Page_Render();
?>
...
var CurrentForm = fproductoespecificacionesedit = new ew_Form("fproductoespecificacionesedit", "edit");

// Validate form
fproductoespecificacionesedit.Validate = function() {
...
fproductoespecificacionesedit.Form_CustomValidate = 
...
fproductoespecificacionesedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductoespecificacionesedit.Lists["x_producto_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_producto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"productos"};
fproductoespecificacionesedit.Lists["x_producto_id"].Data = "<?php echo $productoespecificaciones_edit->producto_id->LookupFilterQuery(FALSE, "edit") ?>";
fproductoespecificacionesedit.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductoespecificacionesedit.Lists["x_activo"].Options = <?php echo json_encode($productoespecificaciones_edit->activo->Options()) ?>;
...
<?php $productoespecificaciones_edit->ShowPageHeader(); ?>
<?php
$productoespecificaciones_edit->ShowMessage();
?>
<form name="fproductoespecificacionesedit" id="fproductoespecificacionesedit" class="<?php echo $productoespecificaciones_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($productoespecificaciones_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $productoespecificaciones_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="productoespecificaciones">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($productoespecificaciones_edit->IsModal) ?>">
...
<?php if ($productoespecificaciones->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_productoespecificaciones_id" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->id->FldCaption() ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->id->CellAttributes() ?>>
<span id="el_productoespecificaciones_id">
...
<input type="hidden" data-table="productoespecificaciones" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($productoespecificaciones->id->CurrentValue) ?>">
<?php echo $productoespecificaciones->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($productoespecificaciones->producto_id->Visible) { // producto_id ?>
	<div id="r_producto_id" class="form-group">
		<label id="elh_productoespecificaciones_producto_id" for="x_producto_id" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->producto_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->producto_id->CellAttributes() ?>>
...
<?php if ($productoespecificaciones->categoria->Visible) { // categoria ?>
	<div id="r_categoria" class="form-group">
		<label id="elh_productoespecificaciones_categoria" for="x_categoria" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->categoria->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->categoria->CellAttributes() ?>>
...
<?php if ($productoespecificaciones->especificaciones->Visible) { // especificaciones ?>
	<div id="r_especificaciones" class="form-group">
		<label id="elh_productoespecificaciones_especificaciones" for="x_especificaciones" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->especificaciones->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->especificaciones->CellAttributes() ?>>
...
<?php if ($productoespecificaciones->orden->Visible) { // orden ?>
	<div id="r_orden" class="form-group">
		<label id="elh_productoespecificaciones_orden" for="x_orden" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->orden->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->orden->CellAttributes() ?>>
...
<?php if ($productoespecificaciones->id_copy->Visible) { // id copy ?>
	<div id="r_id_copy" class="form-group">
		<label id="elh_productoespecificaciones_id_copy" for="x_id_copy" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->id_copy->FldCaption() ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->id_copy->CellAttributes() ?>>
...
<?php if ($productoespecificaciones->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_productoespecificaciones_activo" for="x_activo" class="<?php echo $productoespecificaciones_edit->LeftColumnClass ?>"><?php echo $productoespecificaciones->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productoespecificaciones_edit->RightColumnClass ?>"><div<?php echo $productoespecificaciones->activo->CellAttributes() ?>>
...
<?php if (!$productoespecificaciones_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $productoespecificaciones_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $productoespecificaciones_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fproductoespecificacionesedit.Init();
</script>
<?php
$productoespecificaciones_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$productoespecificaciones_edit->Page_Terminate();
?>
