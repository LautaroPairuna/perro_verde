...
$productoespecificaciones_view = NULL; // Initialize page object first

class cproductoespecificaciones_view extends cproductoespecificaciones {
	...
	// Page object name
	var $PageObjName = 'productoespecificaciones_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "productoespecificacioneslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "productoespecificacioneslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "productoespecificacioneslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($productoespecificaciones_view)) $productoespecificaciones_view = new cproductoespecificaciones_view();

// Page init
$productoespecificaciones_view->Page_Init();

// Page main
$productoespecificaciones_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$productoespecificaciones_view->Page_Render();
?>
...
var CurrentForm = fproductoespecificacionesview = new ew_Form("fproductoespecificacionesview", "view");

// Form_CustomValidate event
fproductoespecificacionesview.Form_CustomValidate = 
...
fproductoespecificacionesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductoespecificacionesview.Lists["x_producto_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_producto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"productos"};
fproductoespecificacionesview.Lists["x_producto_id"].Data = "<?php echo $productoespecificaciones_view->producto_id->LookupFilterQuery(FALSE, "view") ?>";
fproductoespecificacionesview.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductoespecificacionesview.Lists["x_activo"].Options = <?php echo json_encode($productoespecificaciones_view->activo->Options()) ?>;
...
<div class="ewToolbar">
<?php $productoespecificaciones_view->ExportOptions->Render("body") ?>
<?php
	foreach ($productoespecificaciones_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $productoespecificaciones_view->ShowPageHeader(); ?>
<?php
$productoespecificaciones_view->ShowMessage();
?>
<form name="fproductoespecificacionesview" id="fproductoespecificacionesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($productoespecificaciones_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $productoespecificaciones_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="productoespecificaciones">
<input type="hidden" name="modal" value="<?php echo intval($productoespecificaciones_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($productoespecificaciones->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_id"><?php echo $productoespecificaciones->id->FldCaption() ?></span></td>
...
<?php echo $productoespecificaciones->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoespecificaciones->producto_id->Visible) { // producto_id ?>
	<tr id="r_producto_id">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_producto_id"><?php echo $productoespecificaciones->producto_id->FldCaption() ?></span></td>
		<td data-name="producto_id"<?php echo $productoespecificaciones->producto_id->CellAttributes() ?>>
<span id="el_productoespecificaciones_producto_id">
<span<?php echo $productoespecificaciones->producto_id->ViewAttributes() ?>>
<?php echo $productoespecificaciones->producto_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoespecificaciones->categoria->Visible) { // categoria ?>
	<tr id="r_categoria">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_categoria"><?php echo $productoespecificaciones->categoria->FldCaption() ?></span></td>
...
<?php echo $productoespecificaciones->categoria->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoespecificaciones->especificaciones->Visible) { // especificaciones ?>
	<tr id="r_especificaciones">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_especificaciones"><?php echo $productoespecificaciones->especificaciones->FldCaption() ?></span></td>
...
<?php echo $productoespecificaciones->especificaciones->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoespecificaciones->orden->Visible) { // orden ?>
	<tr id="r_orden">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_orden"><?php echo $productoespecificaciones->orden->FldCaption() ?></span></td>
...
<?php echo $productoespecificaciones->orden->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoespecificaciones->id_copy->Visible) { // id copy ?>
	<tr id="r_id_copy">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_id_copy"><?php echo $productoespecificaciones->id_copy->FldCaption() ?></span></td>
...
<?php echo $productoespecificaciones->id_copy->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoespecificaciones->activo->Visible) { // activo ?>
	<tr id="r_activo">
		<td class="col-sm-2"><span id="elh_productoespecificaciones_activo"><?php echo $productoespecificaciones->activo->FldCaption() ?></span></td>
...
<?php echo $productoespecificaciones->activo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fproductoespecificacionesview.Init();
</script>
<?php
$productoespecificaciones_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$productoespecificaciones_view->Page_Terminate();
?>
