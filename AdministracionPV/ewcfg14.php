...
define("EW_PROJECT_NAME", "perroverde", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{BC212F19-BD83-48ED-BA40-11E3CCFC3AA2}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'DT5GZXrgZXqj0fBG', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/perroverde.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "perro_verde_perro_verde_mysql", "port" => 3306, "user" => "mysql", "pass" => "1234567", "db" => "perro_verde", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("es", "", "english.xml");
...
// Security
define("EW_ADMIN_USER_NAME", "AdministratorPV", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "F3rn@ndoPV", TRUE); // Administrator password
...
define("EW_UPLOAD_DEST_PATH", "../public/images/", TRUE); // Upload destination path (relative to app root)
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,webp,svg", TRUE); // Allowed file extensions
