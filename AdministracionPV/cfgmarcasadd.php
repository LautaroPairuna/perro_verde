...
$cfgmarcas_add = NULL; // Initialize page object first

class ccfgmarcas_add extends ccfgmarcas {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cfgmarcasview.php")
...
// Create page object
if (!isset($cfgmarcas_add)) $cfgmarcas_add = new ccfgmarcas_add();

// Page init
$cfgmarcas_add->Page_Init();

// Page main
$cfgmarcas_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfgmarcas_add->Page_Render();
?>
...
var CurrentForm = fcfgmarcasadd = new ew_Form("fcfgmarcasadd", "add");

// Validate form
fcfgmarcasadd.Validate = function() {
...
fcfgmarcasadd.Form_CustomValidate = 
...
fcfgmarcasadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcfgmarcasadd.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfgmarcasadd.Lists["x_activo"].Options = <?php echo json_encode($cfgmarcas_add->activo->Options()) ?>;
...
<?php $cfgmarcas_add->ShowPageHeader(); ?>
<?php
$cfgmarcas_add->ShowMessage();
?>
<form name="fcfgmarcasadd" id="fcfgmarcasadd" class="<?php echo $cfgmarcas_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfgmarcas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfgmarcas_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cfgmarcas">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cfgmarcas_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($cfgmarcas->marca->Visible) { // marca ?>
	<div id="r_marca" class="form-group">
		<label id="elh_cfgmarcas_marca" for="x_marca" class="<?php echo $cfgmarcas_add->LeftColumnClass ?>"><?php echo $cfgmarcas->marca->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgmarcas_add->RightColumnClass ?>"><div<?php echo $cfgmarcas->marca->CellAttributes() ?>>
...
<?php if ($cfgmarcas->keywords->Visible) { // keywords ?>
	<div id="r_keywords" class="form-group">
		<label id="elh_cfgmarcas_keywords" for="x_keywords" class="<?php echo $cfgmarcas_add->LeftColumnClass ?>"><?php echo $cfgmarcas->keywords->FldCaption() ?></label>
		<div class="<?php echo $cfgmarcas_add->RightColumnClass ?>"><div<?php echo $cfgmarcas->keywords->CellAttributes() ?>>
...
<?php if ($cfgmarcas->foto->Visible) { // foto ?>
	<div id="r_foto" class="form-group">
		<label id="elh_cfgmarcas_foto" class="<?php echo $cfgmarcas_add->LeftColumnClass ?>"><?php echo $cfgmarcas->foto->FldCaption() ?></label>
		<div class="<?php echo $cfgmarcas_add->RightColumnClass ?>"><div<?php echo $cfgmarcas->foto->CellAttributes() ?>>
...
<?php if ($cfgmarcas->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_cfgmarcas_activo" for="x_activo" class="<?php echo $cfgmarcas_add->LeftColumnClass ?>"><?php echo $cfgmarcas->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgmarcas_add->RightColumnClass ?>"><div<?php echo $cfgmarcas->activo->CellAttributes() ?>>
...
<?php if (!$cfgmarcas_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cfgmarcas_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfgmarcas_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
