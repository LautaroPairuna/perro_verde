...
//
// Table class for cfgrubros
//
class ccfgrubros extends cTable {
	var $id;
	var $rubro;
	var $condiciones;
	var $keywords;
	...
	function __construct() {
		...
		$this->TableVar = 'cfgrubros';
		$this->TableName = 'cfgrubros';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`cfgrubros`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('cfgrubros', 'cfgrubros', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// rubro
		$this->rubro = new cField('cfgrubros', 'cfgrubros', 'x_rubro', 'rubro', '`rubro`', '`rubro`', 200, -1, FALSE, '`rubro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rubro->Sortable = TRUE; // Allow sort
		$this->fields['rubro'] = &$this->rubro;

		// condiciones
		$this->condiciones = new cField('cfgrubros', 'cfgrubros', 'x_condiciones', 'condiciones', '`condiciones`', '`condiciones`', 200, -1, FALSE, '`condiciones`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->condiciones->Sortable = TRUE; // Allow sort
		$this->fields['condiciones'] = &$this->condiciones;

		// keywords
		$this->keywords = new cField('cfgrubros', 'cfgrubros', 'x_keywords', 'keywords', '`keywords`', '`keywords`', 200, -1, FALSE, '`keywords`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keywords->Sortable = TRUE; // Allow sort
		$this->fields['keywords'] = &$this->keywords;

		// foto
		$this->foto = new cField('cfgrubros', 'cfgrubros', 'x_foto', 'foto', '`foto`', '`foto`', 200, -1, TRUE, '`foto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->foto->Sortable = TRUE; // Allow sort
		$this->fields['foto'] = &$this->foto;

		// activo
		$this->activo = new cField('cfgrubros', 'cfgrubros', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cfgrubros`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`rubro` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "cfgrubrosedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cfgrubrosadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cfgrubrosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cfgrubrosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cfgrubrosadd.php?" . $this->UrlParm($parm);
		else
			$url = "cfgrubrosadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cfgrubrosedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cfgrubrosadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cfgrubrosdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->condiciones->setDbValue($rs->fields('condiciones'));
	...
	function RenderEditRow() {
		...
		$this->condiciones->EditValue = $this->condiciones->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->condiciones->Exportable) $Doc->ExportCaption($this->condiciones);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->condiciones->Exportable) $Doc->ExportField($this->condiciones);
