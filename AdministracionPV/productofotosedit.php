...
$productofotos_edit = NULL; // Initialize page object first

class cproductofotos_edit extends cproductofotos {
	...
	// Page object name
	var $PageObjName = 'productofotos_edit';
...
// Create page object
if (!isset($productofotos_edit)) $productofotos_edit = new cproductofotos_edit();

// Page init
$productofotos_edit->Page_Init();

// Page main
$productofotos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$productofotos_edit->Page_Render();
?>
...
var CurrentForm = fproductofotosedit = new ew_Form("fproductofotosedit", "edit");

// Validate form
fproductofotosedit.Validate = function() {
...
fproductofotosedit.Form_CustomValidate = 
...
fproductofotosedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductofotosedit.Lists["x_producto_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_producto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"productos"};
fproductofotosedit.Lists["x_producto_id"].Data = "<?php echo $productofotos_edit->producto_id->LookupFilterQuery(FALSE, "edit") ?>";
fproductofotosedit.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductofotosedit.Lists["x_activo"].Options = <?php echo json_encode($productofotos_edit->activo->Options()) ?>;
...
<?php $productofotos_edit->ShowPageHeader(); ?>
<?php
$productofotos_edit->ShowMessage();
?>
<form name="fproductofotosedit" id="fproductofotosedit" class="<?php echo $productofotos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($productofotos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $productofotos_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="productofotos">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($productofotos_edit->IsModal) ?>">
...
<?php if ($productofotos->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_productofotos_id" class="<?php echo $productofotos_edit->LeftColumnClass ?>"><?php echo $productofotos->id->FldCaption() ?></label>
		<div class="<?php echo $productofotos_edit->RightColumnClass ?>"><div<?php echo $productofotos->id->CellAttributes() ?>>
<span id="el_productofotos_id">
<span<?php echo $productofotos->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $productofotos->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="productofotos" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($productofotos->id->CurrentValue) ?>">
<?php echo $productofotos->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($productofotos->producto_id->Visible) { // producto_id ?>
	<div id="r_producto_id" class="form-group">
		<label id="elh_productofotos_producto_id" for="x_producto_id" class="<?php echo $productofotos_edit->LeftColumnClass ?>"><?php echo $productofotos->producto_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productofotos_edit->RightColumnClass ?>"><div<?php echo $productofotos->producto_id->CellAttributes() ?>>
...
<?php if ($productofotos->epigrafe->Visible) { // epigrafe ?>
	<div id="r_epigrafe" class="form-group">
		<label id="elh_productofotos_epigrafe" for="x_epigrafe" class="<?php echo $productofotos_edit->LeftColumnClass ?>"><?php echo $productofotos->epigrafe->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productofotos_edit->RightColumnClass ?>"><div<?php echo $productofotos->epigrafe->CellAttributes() ?>>
...
<?php if ($productofotos->foto->Visible) { // foto ?>
	<div id="r_foto" class="form-group">
		<label id="elh_productofotos_foto" class="<?php echo $productofotos_edit->LeftColumnClass ?>"><?php echo $productofotos->foto->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productofotos_edit->RightColumnClass ?>"><div<?php echo $productofotos->foto->CellAttributes() ?>>
...
<?php if ($productofotos->orden->Visible) { // orden ?>
	<div id="r_orden" class="form-group">
		<label id="elh_productofotos_orden" for="x_orden" class="<?php echo $productofotos_edit->LeftColumnClass ?>"><?php echo $productofotos->orden->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productofotos_edit->RightColumnClass ?>"><div<?php echo $productofotos->orden->CellAttributes() ?>>
...
<?php if ($productofotos->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_productofotos_activo" for="x_activo" class="<?php echo $productofotos_edit->LeftColumnClass ?>"><?php echo $productofotos->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $productofotos_edit->RightColumnClass ?>"><div<?php echo $productofotos->activo->CellAttributes() ?>>
...
<?php if (!$productofotos_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $productofotos_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $productofotos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fproductofotosedit.Init();
</script>
<?php
$productofotos_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$productofotos_edit->Page_Terminate();
?>
