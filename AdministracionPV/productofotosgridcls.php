...
$productofotos_grid = NULL; // Initialize page object first

class cproductofotos_grid extends cproductofotos {
	...
	// Page object name
	var $PageObjName = 'productofotos_grid';

	// Grid form hidden field names
	var $FormName = 'fproductofotosgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["productofotos"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "productos") {
			...
			if ($GLOBALS["productos"]->EventCancelled) $this->EventCancelled = TRUE;
		}
