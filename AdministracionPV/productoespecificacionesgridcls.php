...
$productoespecificaciones_grid = NULL; // Initialize page object first

class cproductoespecificaciones_grid extends cproductoespecificaciones {
	...
	// Page object name
	var $PageObjName = 'productoespecificaciones_grid';

	// Grid form hidden field names
	var $FormName = 'fproductoespecificacionesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["productoespecificaciones"];
