...
class cproductos extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('productos', 'productos', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// producto
		$this->producto = new cField('productos', 'productos', 'x_producto', 'producto', '`producto`', '`producto`', 200, -1, FALSE, '`producto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->producto->Sortable = TRUE; // Allow sort
		$this->fields['producto'] = &$this->producto;

		// marca_id
		$this->marca_id = new cField('productos', 'productos', 'x_marca_id', 'marca_id', '`marca_id`', '`marca_id`', 3, -1, FALSE, '`marca_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->marca_id->Sortable = TRUE; // Allow sort
		$this->marca_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->marca_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->marca_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['marca_id'] = &$this->marca_id;

		// rubro_id
		$this->rubro_id = new cField('productos', 'productos', 'x_rubro_id', 'rubro_id', '`rubro_id`', '`rubro_id`', 3, -1, FALSE, '`rubro_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->rubro_id->Sortable = TRUE; // Allow sort
		$this->rubro_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->rubro_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->rubro_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['rubro_id'] = &$this->rubro_id;

		// moneda_id
		$this->moneda_id = new cField('productos', 'productos', 'x_moneda_id', 'moneda_id', '`moneda_id`', '`moneda_id`', 3, -1, FALSE, '`moneda_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->moneda_id->Sortable = TRUE; // Allow sort
		$this->moneda_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->moneda_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->moneda_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['moneda_id'] = &$this->moneda_id;

		// descripcion
		$this->descripcion = new cField('productos', 'productos', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 200, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->descripcion->Sortable = TRUE; // Allow sort
		$this->fields['descripcion'] = &$this->descripcion;

		// foto
		$this->foto = new cField('productos', 'productos', 'x_foto', 'foto', '`foto`', '`foto`', 200, -1, TRUE, '`foto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->foto->Sortable = TRUE; // Allow sort
		$this->fields['foto'] = &$this->foto;

		// precio
		$this->precio = new cField('productos', 'productos', 'x_precio', 'precio', '`precio`', '`precio`', 131, -1, FALSE, '`precio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// stock
		$this->stock = new cField('productos', 'productos', 'x_stock', 'stock', '`stock`', '`stock`', 3, -1, FALSE, '`stock`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// destacado
		$this->destacado = new cField('productos', 'productos', 'x_destacado', 'destacado', '`destacado`', '`destacado`', 16, -1, FALSE, '`destacado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->destacado->Sortable = TRUE; // Allow sort
		$this->destacado->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->destacado->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->destacado->OptionCount = 2;
		$this->destacado->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['destacado'] = &$this->destacado;

		// visitas
		$this->visitas = new cField('productos', 'productos', 'x_visitas', 'visitas', '`visitas`', '`visitas`', 3, -1, FALSE, '`visitas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// activo
		$this->activo = new cField('productos', 'productos', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "productoespecificaciones") {
			$sDetailUrl = $GLOBALS["productoespecificaciones"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "productofotos") {
			$sDetailUrl = $GLOBALS["productofotos"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($this->getCurrentDetailTable() == "productoversiones") {
			$sDetailUrl = $GLOBALS["productoversiones"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "productoslist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`productos`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`producto` ASC";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("productosview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("productosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "productosadd.php?" . $this->UrlParm($parm);
		else
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("productosedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("productosedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("productosadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("productosadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->producto->setDbValue($rs->fields('producto'));
		$this->marca_id->setDbValue($rs->fields('marca_id'));
		$this->rubro_id->setDbValue($rs->fields('rubro_id'));
		$this->moneda_id->setDbValue($rs->fields('moneda_id'));
		$this->descripcion->setDbValue($rs->fields('descripcion'));
		$this->foto->Upload->DbValue = $rs->fields('foto');
		$this->precio->setDbValue($rs->fields('precio'));
		$this->stock->setDbValue($rs->fields('stock'));
		$this->destacado->setDbValue($rs->fields('destacado'));
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->producto->Exportable) $Doc->ExportCaption($this->producto);
					if ($this->marca_id->Exportable) $Doc->ExportCaption($this->marca_id);
					if ($this->rubro_id->Exportable) $Doc->ExportCaption($this->rubro_id);
					if ($this->moneda_id->Exportable) $Doc->ExportCaption($this->moneda_id);
					...
					if ($this->destacado->Exportable) $Doc->ExportCaption($this->destacado);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->producto->Exportable) $Doc->ExportField($this->producto);
						if ($this->marca_id->Exportable) $Doc->ExportField($this->marca_id);
						if ($this->rubro_id->Exportable) $Doc->ExportField($this->rubro_id);
						if ($this->moneda_id->Exportable) $Doc->ExportField($this->moneda_id);
						...
						if ($this->destacado->Exportable) $Doc->ExportField($this->destacado);
