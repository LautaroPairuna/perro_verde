...
$cfgmonedas_add = NULL; // Initialize page object first

class ccfgmonedas_add extends ccfgmonedas {
	...
	// Page object name
	var $PageObjName = 'cfgmonedas_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "cfgmonedasview.php")
	...
	function LoadDefaultValues() {
		...
		$this->moneda_des->CurrentValue = NULL;
		$this->moneda_des->OldValue = $this->moneda_des->CurrentValue;
	...
	function NewRow() {
		...
		$row['moneda_des'] = $this->moneda_des->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// moneda_des
		$this->moneda_des->SetDbValueDef($rsnew, $this->moneda_des->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($cfgmonedas_add)) $cfgmonedas_add = new ccfgmonedas_add();

// Page init
$cfgmonedas_add->Page_Init();

// Page main
$cfgmonedas_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfgmonedas_add->Page_Render();
?>
...
var CurrentForm = fcfgmonedasadd = new ew_Form("fcfgmonedasadd", "add");

// Validate form
fcfgmonedasadd.Validate = function() {
...
fcfgmonedasadd.Form_CustomValidate = 
...
fcfgmonedasadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcfgmonedasadd.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfgmonedasadd.Lists["x_activo"].Options = <?php echo json_encode($cfgmonedas_add->activo->Options()) ?>;
...
<?php $cfgmonedas_add->ShowPageHeader(); ?>
<?php
$cfgmonedas_add->ShowMessage();
?>
<form name="fcfgmonedasadd" id="fcfgmonedasadd" class="<?php echo $cfgmonedas_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfgmonedas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfgmonedas_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cfgmonedas">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($cfgmonedas_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($cfgmonedas->moneda->Visible) { // moneda ?>
	<div id="r_moneda" class="form-group">
		<label id="elh_cfgmonedas_moneda" for="x_moneda" class="<?php echo $cfgmonedas_add->LeftColumnClass ?>"><?php echo $cfgmonedas->moneda->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgmonedas_add->RightColumnClass ?>"><div<?php echo $cfgmonedas->moneda->CellAttributes() ?>>
...
<?php if ($cfgmonedas->moneda_des->Visible) { // moneda_des ?>
	<div id="r_moneda_des" class="form-group">
		<label id="elh_cfgmonedas_moneda_des" for="x_moneda_des" class="<?php echo $cfgmonedas_add->LeftColumnClass ?>"><?php echo $cfgmonedas->moneda_des->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgmonedas_add->RightColumnClass ?>"><div<?php echo $cfgmonedas->moneda_des->CellAttributes() ?>>
...
<?php if ($cfgmonedas->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_cfgmonedas_activo" for="x_activo" class="<?php echo $cfgmonedas_add->LeftColumnClass ?>"><?php echo $cfgmonedas->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgmonedas_add->RightColumnClass ?>"><div<?php echo $cfgmonedas->activo->CellAttributes() ?>>
...
<?php if (!$cfgmonedas_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cfgmonedas_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfgmonedas_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
