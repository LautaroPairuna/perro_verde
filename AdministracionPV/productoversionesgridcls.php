...
$productoversiones_grid = NULL; // Initialize page object first

class cproductoversiones_grid extends cproductoversiones {
	...
	// Page object name
	var $PageObjName = 'productoversiones_grid';

	// Grid form hidden field names
	var $FormName = 'fproductoversionesgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["productoversiones"];
