...
//
// Table class for cfgmarcas
//
class ccfgmarcas extends cTable {
	var $id;
	var $marca;
	var $keywords;
	var $foto;
	...
	function __construct() {
		...
		$this->TableVar = 'cfgmarcas';
		$this->TableName = 'cfgmarcas';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`cfgmarcas`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('cfgmarcas', 'cfgmarcas', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// marca
		$this->marca = new cField('cfgmarcas', 'cfgmarcas', 'x_marca', 'marca', '`marca`', '`marca`', 200, -1, FALSE, '`marca`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->marca->Sortable = TRUE; // Allow sort
		$this->fields['marca'] = &$this->marca;

		// keywords
		$this->keywords = new cField('cfgmarcas', 'cfgmarcas', 'x_keywords', 'keywords', '`keywords`', '`keywords`', 200, -1, FALSE, '`keywords`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keywords->Sortable = TRUE; // Allow sort
		$this->fields['keywords'] = &$this->keywords;

		// foto
		$this->foto = new cField('cfgmarcas', 'cfgmarcas', 'x_foto', 'foto', '`foto`', '`foto`', 200, -1, TRUE, '`foto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->foto->Sortable = TRUE; // Allow sort
		$this->fields['foto'] = &$this->foto;

		// activo
		$this->activo = new cField('cfgmarcas', 'cfgmarcas', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`cfgmarcas`";
	}
	...
	function getSqlOrderBy() { // Order By
		return ($this->_SqlOrderBy <> "") ? $this->_SqlOrderBy : "`marca` ASC";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "cfgmarcasedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "cfgmarcasadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("cfgmarcasview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("cfgmarcasview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "cfgmarcasadd.php?" . $this->UrlParm($parm);
		else
			$url = "cfgmarcasadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("cfgmarcasedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("cfgmarcasadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("cfgmarcasdelete.php", $this->UrlParm());
	}
