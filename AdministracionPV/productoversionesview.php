...
$productoversiones_view = NULL; // Initialize page object first

class cproductoversiones_view extends cproductoversiones {
	...
	// Page object name
	var $PageObjName = 'productoversiones_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "productoversioneslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "productoversioneslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "productoversioneslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($productoversiones_view)) $productoversiones_view = new cproductoversiones_view();

// Page init
$productoversiones_view->Page_Init();

// Page main
$productoversiones_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$productoversiones_view->Page_Render();
?>
...
var CurrentForm = fproductoversionesview = new ew_Form("fproductoversionesview", "view");

// Form_CustomValidate event
fproductoversionesview.Form_CustomValidate = 
...
fproductoversionesview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fproductoversionesview.Lists["x_producto_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_producto","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"productos"};
fproductoversionesview.Lists["x_producto_id"].Data = "<?php echo $productoversiones_view->producto_id->LookupFilterQuery(FALSE, "view") ?>";
fproductoversionesview.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fproductoversionesview.Lists["x_activo"].Options = <?php echo json_encode($productoversiones_view->activo->Options()) ?>;
...
<div class="ewToolbar">
<?php $productoversiones_view->ExportOptions->Render("body") ?>
<?php
	foreach ($productoversiones_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $productoversiones_view->ShowPageHeader(); ?>
<?php
$productoversiones_view->ShowMessage();
?>
<form name="fproductoversionesview" id="fproductoversionesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($productoversiones_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $productoversiones_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="productoversiones">
<input type="hidden" name="modal" value="<?php echo intval($productoversiones_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($productoversiones->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_productoversiones_id"><?php echo $productoversiones->id->FldCaption() ?></span></td>
...
<?php echo $productoversiones->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoversiones->producto_id->Visible) { // producto_id ?>
	<tr id="r_producto_id">
		<td class="col-sm-2"><span id="elh_productoversiones_producto_id"><?php echo $productoversiones->producto_id->FldCaption() ?></span></td>
		<td data-name="producto_id"<?php echo $productoversiones->producto_id->CellAttributes() ?>>
<span id="el_productoversiones_producto_id">
<span<?php echo $productoversiones->producto_id->ViewAttributes() ?>>
<?php echo $productoversiones->producto_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoversiones->version->Visible) { // version ?>
	<tr id="r_version">
		<td class="col-sm-2"><span id="elh_productoversiones_version"><?php echo $productoversiones->version->FldCaption() ?></span></td>
...
<?php echo $productoversiones->version->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoversiones->detalle->Visible) { // detalle ?>
	<tr id="r_detalle">
		<td class="col-sm-2"><span id="elh_productoversiones_detalle"><?php echo $productoversiones->detalle->FldCaption() ?></span></td>
...
<?php echo $productoversiones->detalle->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoversiones->orden->Visible) { // orden ?>
	<tr id="r_orden">
		<td class="col-sm-2"><span id="elh_productoversiones_orden"><?php echo $productoversiones->orden->FldCaption() ?></span></td>
...
<?php echo $productoversiones->orden->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($productoversiones->activo->Visible) { // activo ?>
	<tr id="r_activo">
		<td class="col-sm-2"><span id="elh_productoversiones_activo"><?php echo $productoversiones->activo->FldCaption() ?></span></td>
...
<?php echo $productoversiones->activo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fproductoversionesview.Init();
</script>
<?php
$productoversiones_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$productoversiones_view->Page_Terminate();
?>
