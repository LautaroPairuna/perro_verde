...
$cfgformaspagos_edit = NULL; // Initialize page object first

class ccfgformaspagos_edit extends ccfgformaspagos {
	...
	// Page object name
	var $PageObjName = 'cfgformaspagos_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// forma_pago
			$this->forma_pago->SetDbValueDef($rsnew, $this->forma_pago->CurrentValue, "", $this->forma_pago->ReadOnly);

			// descripcion
			$this->descripcion->SetDbValueDef($rsnew, $this->descripcion->CurrentValue, "", $this->descripcion->ReadOnly);

			// permite_cuotas
			$this->permite_cuotas->SetDbValueDef($rsnew, $this->permite_cuotas->CurrentValue, 0, $this->permite_cuotas->ReadOnly);
...
// Create page object
if (!isset($cfgformaspagos_edit)) $cfgformaspagos_edit = new ccfgformaspagos_edit();

// Page init
$cfgformaspagos_edit->Page_Init();

// Page main
$cfgformaspagos_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cfgformaspagos_edit->Page_Render();
?>
...
var CurrentForm = fcfgformaspagosedit = new ew_Form("fcfgformaspagosedit", "edit");

// Validate form
fcfgformaspagosedit.Validate = function() {
...
fcfgformaspagosedit.Form_CustomValidate = 
...
fcfgformaspagosedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fcfgformaspagosedit.Lists["x_permite_cuotas"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfgformaspagosedit.Lists["x_permite_cuotas"].Options = <?php echo json_encode($cfgformaspagos_edit->permite_cuotas->Options()) ?>;
fcfgformaspagosedit.Lists["x_activo"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fcfgformaspagosedit.Lists["x_activo"].Options = <?php echo json_encode($cfgformaspagos_edit->activo->Options()) ?>;
...
<?php $cfgformaspagos_edit->ShowPageHeader(); ?>
<?php
$cfgformaspagos_edit->ShowMessage();
?>
<form name="fcfgformaspagosedit" id="fcfgformaspagosedit" class="<?php echo $cfgformaspagos_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cfgformaspagos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cfgformaspagos_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cfgformaspagos">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cfgformaspagos_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($cfgformaspagos->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_cfgformaspagos_id" class="<?php echo $cfgformaspagos_edit->LeftColumnClass ?>"><?php echo $cfgformaspagos->id->FldCaption() ?></label>
		<div class="<?php echo $cfgformaspagos_edit->RightColumnClass ?>"><div<?php echo $cfgformaspagos->id->CellAttributes() ?>>
<span id="el_cfgformaspagos_id">
<span<?php echo $cfgformaspagos->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $cfgformaspagos->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="cfgformaspagos" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($cfgformaspagos->id->CurrentValue) ?>">
<?php echo $cfgformaspagos->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cfgformaspagos->forma_pago->Visible) { // forma_pago ?>
	<div id="r_forma_pago" class="form-group">
		<label id="elh_cfgformaspagos_forma_pago" for="x_forma_pago" class="<?php echo $cfgformaspagos_edit->LeftColumnClass ?>"><?php echo $cfgformaspagos->forma_pago->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgformaspagos_edit->RightColumnClass ?>"><div<?php echo $cfgformaspagos->forma_pago->CellAttributes() ?>>
...
<?php if ($cfgformaspagos->descripcion->Visible) { // descripcion ?>
	<div id="r_descripcion" class="form-group">
		<label id="elh_cfgformaspagos_descripcion" for="x_descripcion" class="<?php echo $cfgformaspagos_edit->LeftColumnClass ?>"><?php echo $cfgformaspagos->descripcion->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgformaspagos_edit->RightColumnClass ?>"><div<?php echo $cfgformaspagos->descripcion->CellAttributes() ?>>
...
<?php if ($cfgformaspagos->permite_cuotas->Visible) { // permite_cuotas ?>
	<div id="r_permite_cuotas" class="form-group">
		<label id="elh_cfgformaspagos_permite_cuotas" for="x_permite_cuotas" class="<?php echo $cfgformaspagos_edit->LeftColumnClass ?>"><?php echo $cfgformaspagos->permite_cuotas->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgformaspagos_edit->RightColumnClass ?>"><div<?php echo $cfgformaspagos->permite_cuotas->CellAttributes() ?>>
...
<?php if ($cfgformaspagos->activo->Visible) { // activo ?>
	<div id="r_activo" class="form-group">
		<label id="elh_cfgformaspagos_activo" for="x_activo" class="<?php echo $cfgformaspagos_edit->LeftColumnClass ?>"><?php echo $cfgformaspagos->activo->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cfgformaspagos_edit->RightColumnClass ?>"><div<?php echo $cfgformaspagos->activo->CellAttributes() ?>>
...
<?php if (!$cfgformaspagos_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cfgformaspagos_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cfgformaspagos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fcfgformaspagosedit.Init();
</script>
<?php
$cfgformaspagos_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$cfgformaspagos_edit->Page_Terminate();
?>
