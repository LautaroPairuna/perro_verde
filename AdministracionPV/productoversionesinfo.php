...
$productoversiones = NULL;

//
// Table class for productoversiones
//
class cproductoversiones extends cTable {
	var $id;
	var $producto_id;
	var $version;
	var $detalle;
	...
	function __construct() {
		...
		$this->TableVar = 'productoversiones';
		$this->TableName = 'productoversiones';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`productoversiones`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('productoversiones', 'productoversiones', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// producto_id
		$this->producto_id = new cField('productoversiones', 'productoversiones', 'x_producto_id', 'producto_id', '`producto_id`', '`producto_id`', 3, -1, FALSE, '`producto_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// version
		$this->version = new cField('productoversiones', 'productoversiones', 'x_version', 'version', '`version`', '`version`', 200, -1, FALSE, '`version`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->version->Sortable = TRUE; // Allow sort
		$this->fields['version'] = &$this->version;

		// detalle
		$this->detalle = new cField('productoversiones', 'productoversiones', 'x_detalle', 'detalle', '`detalle`', '`detalle`', 200, -1, FALSE, '`detalle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->detalle->Sortable = TRUE; // Allow sort
		$this->fields['detalle'] = &$this->detalle;

		// orden
		$this->orden = new cField('productoversiones', 'productoversiones', 'x_orden', 'orden', '`orden`', '`orden`', 3, -1, FALSE, '`orden`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// activo
		$this->activo = new cField('productoversiones', 'productoversiones', 'x_activo', 'activo', '`activo`', '`activo`', 16, -1, FALSE, '`activo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`productoversiones`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "productoversioneslist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "productoversionesedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "productoversionesadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("productoversionesview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("productoversionesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "productoversionesadd.php?" . $this->UrlParm($parm);
		else
			$url = "productoversionesadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("productoversionesedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("productoversionesadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("productoversionesdelete.php", $this->UrlParm());
	}
